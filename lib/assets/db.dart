...
List<Device> devices = [
  Device('0', 'SL63',
      description: 'SL63 AMG', imageUrl: '${toPath(AppRoute.img)}/sl63.jpg'),
  Device('1', 'JD 9620 RX',
      description: 'John Deere 9620 RX',
      imageUrl: '${toPath(AppRoute.img)}/jd.jpg'),
  Device('2', 'Velociraptor', imageUrl: '${toPath(AppRoute.img)}/velo.jpg'),
  Device('3', 'MacBook Pro 16',
      description: 'MacBook Pro 16 Zoll 8Core 16Gb',
      imageUrl: '${toPath(AppRoute.img)}/mbp.jpg'),
];
